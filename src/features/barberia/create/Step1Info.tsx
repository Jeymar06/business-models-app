  ...
  return (
    <div className="grid gap-4">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div>
          <Input label="Telefono" {...register('telefono')} placeholder="Ej: +573114567890" />
          <FieldError message={errors.telefono?.message} />
        </div>
        <div>
          <Input label="Email de contacto" {...register('emailContacto')} placeholder="Ej: info@barberia.com" />
